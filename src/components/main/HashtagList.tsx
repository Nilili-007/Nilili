...
const HashtagList = () => {
  ...
  return (
    <div
      className={`mt-[10%] pb-[2%] bg-gray-200 w-full xl:min-h-[570px] sm:min-h-[620px] overflow-hidden ${
    ...
    >
      <div className="mx-auto   w-[85%] md:w-[70%]  ">
        ...
        <div className="flex flex-wrap  mt-[3%] font-hashtags w-[98%] ">
          <Link
            onClick={() => {
              hashTagAmplitudeEvent();
            }}
            to={`/search?ht=${JSON.stringify([hashTagOptions[0]])}`}
            className=" border-b-[3px] xl:w-[22%]  sm:w-[30%] w-[47%] pl-[0.3%] pt-2 mr-[3%] sm:text-[25px] text-base  font-normal border-black mb-[5%] hover:bg-black hover:text-white "
          >
            #화목하게 가족과
          </Link>
          <Link
