  ...
  return (
    <>
      <div className="m-[2%] 3xl:w-[30%] 2xl:w-[40%] w-[50%] min-w-[370px] border border-black">
        <div className="flex justify-center items-center p-5 body1">로그인</div>
        <div className="flex justify-center items-center">
          <div className="border-b-2 border-solid border-black w-[90%]" />
        </div>
        <div className="relative p-6 flex-auto">
          <form className="px-8 pt-6 pb-8 w-full flex-auto justify-center items-center">
            ...
            <div className="flex items-center justify-center">
              <button
                className="w-[50%] text-white bg-black font-bold uppercase text-sm px-6 py-3 shadow hover:shadow-lg outline-none focus:outline-none"
                type="submit"
                disabled={isLogin}
